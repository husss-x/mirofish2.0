    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even from a single paragraph, <span class=”highlight-bold”>MiroFish</span> can automatically construct a parallel world of up to <span class=”highlight-orange”>millions of agents</span> from the reality seeds within. Inject variables from a god's-eye view and search for <span class=”highlight-code”>”local optima”</span> amid complex group interactions.
            </p>
            <p class=”slogan-text”>
              Let the future play out among agents. Let decisions win after a hundred simulations.<span class=”blinking-cursor”>_</span>
            </p>
          </div>
      ...
      <!-- Lower section: dual-column layout -->
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk as the primary heading font, JetBrains Mono for code/label text
...
.console-box {
  ...
  padding: 8px; /* Padding to create a double-border effect */
}
