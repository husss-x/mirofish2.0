...
// Fetch maxRounds from query params at initialization time so child components can access it immediately
...
const handleGoBack = async () => {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      // Environment is not running; check whether the process needs to be stopped
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh skips the full-screen loading indicator to prevent flickering
...
onMounted(() => {
  ...
  // Log maxRounds configuration (value was already fetched from query params at initialization)
  if (maxRounds.value) {
