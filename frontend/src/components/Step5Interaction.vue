        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the Report Agent with access to 4 specialized tools and MiroFish's full memory</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">BFS-based graph traversal to reconstruct event propagation paths and capture full information-flow topology</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-powered instant query for fast extraction of node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewer that conducts multi-turn parallel conversations with agents to collect opinions and mental states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to explore report content' : 'Chat with simulation agents to learn their views' }}
              </p>
            </div>
            <div 
...
const renderMarkdown = (content) => {
  ...
  // Remove <br> tags around block-level elements
  ...
  // Remove <br> before a paragraph start tag immediately following a block-level element
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix numbering of non-contiguous ordered lists: keep counter incrementing when single-item <ol> elements are separated by paragraph content
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Convert the object dictionary to an array, preferring the reddit platform reply
...
/* Fix ordered list numbering - use CSS counters to keep multiple ol elements numbered continuously */
.message-text {
...
/* Quote styles for chat and survey areas */
