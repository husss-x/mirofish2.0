...
This script reads parameters from a config file to run the simulation, enabling full automation.
...
class TwitterSimulationRunner:
    ...
    def _get_active_agents_for_round(
        ...
        """
        Decide which Agents to activate for this round based on time and config
...
async def main():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='Close the environment immediately after simulation, without entering command-wait mode'
    )
    ...
    # Initialize logging (use fixed file names, clean up old logs)
