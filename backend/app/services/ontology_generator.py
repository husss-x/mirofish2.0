...
ONTOLOGY_SYSTEM_PROMPT = """You are a professional knowledge graph ontology design expert. Your task is to analyze given text content and simulation requirements to design entity types and relationship types suitable for **social media public opinion simulation**.
...
**Cannot be**:
- Abstract concepts (e.g., "public opinion", "emotion", "trends")
...
A. **Fallback types (required, placed as the last 2 in the list)**:
   - `Person`: The fallback type for any individual person. When a person does not fit any other more specific person type, they fall into this category.
   - `Organization`: The fallback type for any organization. When an organization does not fit any other more specific organization type, it falls into this category.
...
- The text will contain various characters, such as "primary school teachers", "passersby", "certain netizens"
...
**Individual (Fallback)**:
- Person: Any individual person (used when none of the specific types apply)
...
- Organization: Any organization (used when none of the specific types apply)
...
4. All entity types must be real-world actors capable of speaking; they cannot be abstract concepts
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Final guard to ensure the limit is not exceeded (defensive programming)
