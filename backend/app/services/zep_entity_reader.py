...
class ZepEntityReader:
    ...
    2. Filter nodes that match predefined entity types (nodes whose Labels are not only "Entity")
    3. Retrieve related edge and associated node information for each entity
    """
    ...
    def filter_defined_entities(
        ...
        # Get all edges (used for subsequent association lookups)
        ...
        for node in all_nodes:
            ...
            if enrich_with_edges:
                ...
                # Get basic information for associated nodes
                related_nodes = []
