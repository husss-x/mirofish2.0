...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Steps:
        1. Read and filter entities from the Zep knowledge graph
        2. Generate OASIS Agent Profiles for each entity (optional LLM enhancement, parallel support)
        ...
        try:
            ...
            # Reddit was already saved in real time during generation; save once more here to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            # Note: run scripts remain in backend/scripts/ directory and are no longer copied to the simulation directory
