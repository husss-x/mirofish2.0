...
class OasisAgentProfile:
    ...
    def to_reddit_format(self) -> Dict[str, Any]:
        ...
        # Add additional persona info (if present)
        if self.age:
...
class OasisProfileGenerator:
    ...
    Converts entities from the Zep knowledge graph into the Agent Profiles required for OASIS simulation

    Optimization features:
    1. Calls the Zep graph retrieval function to obtain richer context
    2. Generates very detailed personas (including basic info, professional background, personality traits, social media behavior, etc.)
    3. Distinguishes between individual entities and abstract group entities
    """
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """
        Use the Zep graph hybrid search function to get rich information related to the entity
    ...
    def _build_entity_context(self, entity: EntityNode) -> str:
        ...
        # 3. Add detailed info for associated nodes
    ...
    def _is_group_entity(self, entity_type: str) -> bool:
        """Determine if this is a group/institution-type entity"""
    ...
    def _generate_profile_with_llm(
        ...
        - Individual entities: generate a specific character setting
        - Group/institution entities: generate a representative account setting
        """
    ...
    def _fix_truncated_json(self, content: str) -> str:
        """Fix truncated JSON (output was truncated by max_tokens limit)"""
        import re
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        if json_match:
            ...
            # Find all string values and replace their newline characters
        ...
        # 7. Completely failed, return base structure
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate detailed social media account settings for the following institutional/group entity, faithfully reproducing existing real-world conditions.
...
2. persona: Detailed account profile description (2000 words of plain text), including:
   - Basic institutional information (official name, type of institution, founding background, primary functions)
   ...
   - Stance and attitude (official position on key topics, approach to handling controversy)
   - Special notes (profile of the group it represents, operational habits)
   - Institutional memory (an important part of the institutional persona: describe this institution's connection to events and its existing actions and reactions within those events)
3. age: Fixed value of 30 (virtual age for institutional accounts)
4. gender: Fixed value of "other" (institutional accounts use "other" to indicate non-individual)
5. mbti: MBTI type describing the account's style (e.g. ISTJ represents rigorous and conservative)
6. country: Country name (e.g. "China")
...
- Institutional account communications must be consistent with its identity and positioning"""
    ...
    def generate_profiles_from_entities(
        ...
        Args:
            ...
            realtime_output_path: File path for real-time writing (if provided, write after each generation)
    ...
    def save_profiles(
        ...
        """
        Save Profiles to file (select the correct format based on platform)
